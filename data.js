...
const DATA = {
  ...
  kahootQuestions: [
    ...
    {
      id: 'q2',
      question: 'Combien de provinces a le Canada?',
      options: ['8', '10', '12', '13'],
      correctAnswer: 1,
      timeLimit: 15,
    },
    {
      id: 'q3',
      question: 'Quel est le plus grand lac du Québec?',
      options: ['Lac Saint-Jean', 'Lac Mistassini', 'Lac Memphrémagog', 'Lac Champlain'],
      correctAnswer: 1,
      timeLimit: 15,
    },
    {
      id: 'q4',
      question: 'En quelle année Montréal a-t-elle accueilli les Jeux olympiques?',
